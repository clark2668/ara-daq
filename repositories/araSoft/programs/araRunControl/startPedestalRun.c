/*! \file startPedestalRun.c
  \brief The startPedestalRun program is the standalone program for starting a new run

    
  This is the updated startPedestalRun 
...
int main(int argc, char *argv[])
{
  ...
  if (connect(sockfd,(struct sockaddr *) &serv_addr,sizeof(serv_addr)) < 0) 
    ...
    rcMsg.runType=ARA_RUN_TYPE_PEDESTAL;
    //  rcMsg.length=0;    
    setChecksum(&rcMsg);
